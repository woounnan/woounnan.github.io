...
6. 완벽히 주소값을 다루게 되었다!!!! ---------------------- 2019-08-23
   ...
   - 일단 RIP를 printf.plt로 변경해보았다.
   
     ![lfh-sucPrint](C:\Users\Administrator\Downloads\woounnan.github.io\img\lfh-sucPrint.png)
   
     - 올바른 주소로 설정했기 때문에 프로그램이 오류없이 종료되었다.
     - 성공!
   
   - 새로운 계획
   
     - 스택에 스택 주소값이 저장되있는것을 printf로 읽어와서 base를 구한 뒤
     - 그것을 이용해 execve의 주소를 구하여 호출하자!